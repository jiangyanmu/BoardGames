...
public class TicTacToeGUI extends JFrame {
            ...
            for (int j = 0; j < 3; j++) {
                ...
                buttons[i][j].addMouseListener(new MouseAdapter() {
                    public void mouseEntered(MouseEvent evt) {
                        ...
                        if (button.isEnabled()) button.setBorder(buttonHoverBorder);
                    }
    ...
    private class ButtonClickListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            if (game.getGameState() != TicTacToeGame.GameState.PLAYING) return;
    ...
    private void highlightWinningButtons(char winner) {
        ...
        for (int[] line : winLines) {
            if (game.getSymbolAt(line[0], line[1]) == winner &&
                ...
                setWinnerColor(winColor, buttons[line[0]][line[1]], buttons[line[2]][line[3]], buttons[line[4]][line[5]]);
                return;
            }
        }
    }
